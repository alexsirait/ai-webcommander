...
def create_ui(theme_name="Base"):
    ...
    with gr.Blocks(
            title="AI WebCommander - lexAI", theme=theme_map[theme_name], css=css
    ) as demo:
        with gr.Row():
            gr.Markdown(
                """
                # AI WebCommander - lexAI
                ### Kendalikan Web dengan Perintah Anda
                """,
                elem_classes=["header-text"],
            )
        gr.HTML("<div class='fixed-footer'>Made with ♥ by Alex Sirait</div>")
